...
public class CategoryNameFetchCategories extends BaseTest {
    ...
    public  void  xssTest() throws InterruptedException {
        ...
        WebElement catTable= driver.findElement(By.xpath("//table[@id='manageCategoriesTable']//tbody"));
        String brandLabel = catTable.getAttribute("innerHTML");
    ...
    public void reset() {
        ...
        WebElement editCatName = driver.findElement(By.id("editCategoriesName"));
        editCatName.clear();
        editCatName.sendKeys("SmartPhone</b>");
